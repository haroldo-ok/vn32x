...
sh-elf-as -o unpackfire_tiny.o unpackfire_tiny.s
sh-elf-gcc -c -O1 -m1 -o %ROMNAME%.o %ROMNAME%.c
sh-elf-gcc -c -O1 -m1 -o gfx.o data\gfx.c
sh-elf-ld -T 32x.ld -relax -small -e _start --oformat binary -o 32xcode.bin crt0.o %ROMNAME%.o unpackfire_tiny.o gfx.o libc.a libgcc.a
